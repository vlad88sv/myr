<h1>Orden de trabajo #<?php echo $_GET['ID'] ?></h1>
<?php
if (empty($_GET['ID'])) {
...
if (mysqli_num_rows($r_ordenes) > 0) {
    ...
    echo '<h2>Recepción del <b>' . $f['fechatiempo_ingreso'] . '</b> al <b>' . ($f['fechatiempo_egreso_2'] != '' ? $f['fechatiempo_egreso_2'] : 'día de hoy') . '</b></h2>';
